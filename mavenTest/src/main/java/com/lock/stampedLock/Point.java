...
public class Point {
    ...
    double distanceFormOrigin() {//只读方法
        ...
        /**
         * 判断这个stamp是否在读过程发生期间被修改过,如果stamp没有被修改过,
         * 则认为这次读取时有效的,因此就可以直接return了,反之,如果stamp是不可用的,则意味着在读取的过程中,
    ...
    public static void main(String[] args) throws IOException {
        ...
        new Thread(new Runnable() {
            public void run() {
                double v = point.distanceFormOrigin();
